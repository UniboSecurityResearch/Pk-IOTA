...
usage() {
  cat <<'EOF'
Usage:
  run_otsec_overhead.sh [--lab-dir DIR] [--runs N] [--variant V] [--out-dir DIR] [--duration-sec SEC] [--warmup-sec SEC]
...
declare -a REQUIRED_IMAGES=(
  "kathara/p4"
  "telegraf:kathara-net"
  "influxdb:kathara-net"
  "chronograf:kathara-net"
  "kapacitor:kathara-net"
  "ot-industrial-process:kathara-net"
  "ot-openplc:kathara-net"
  "ot-fuxa:kathara-net"
  "ot-attacker:kathara-net"
  "ot-shellinabox:kathara-net"
)
...
if (( ${#MISSING_IMAGES[@]} > 0 )); then
  ...
  echo "Build them first with: ./build_kathara_images.sh" >&2
  exit 1
fi
