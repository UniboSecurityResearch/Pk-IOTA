#!/usr/bin/env python3
"""Analyze paired OT Security overhead runs captured from P4 switch interfaces.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Analyze OT Security overhead runs")
    ...
    lines: List[str] = []
    lines.append("# OT Security Overhead Report")
    lines.append("")
