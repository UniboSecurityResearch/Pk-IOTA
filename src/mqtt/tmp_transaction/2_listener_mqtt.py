...
def callback(event):
    ...
    data_part = testo[2]
    bech32_res = utils.hex_public_key_to_bech32_address("0x97d8b8fdbc9a51644f9e3b9b331bb7500bd470e9bc5aaf5819cc0b90ab1bb12c","0x97d8b8fdbc9a51644f9e3b9b331bb7500bd470e9bc5aaf5819cc0b90ab1bb12c")
    print(bech32_res)
    add_res = utils.parse_bech32_address(bech32_res)
