...
# Plot both lines
sns.lineplot(x=range(len(sw_values)), y=sw_values, marker='o', label='Dequeuing Time with certificate parsing and validation', color='orange')
sns.lineplot(x=range(len(nosw_values)), y=nosw_values, marker='o', label='Dequeuing Time without certificate parsing and validation', color='blue')
