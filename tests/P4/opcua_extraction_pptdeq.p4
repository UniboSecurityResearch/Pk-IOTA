 ...
 * a reference variant (per-packet-time dequeue measurement). The canonical,
 * maintained OPC UA extraction program is testbeds/<lab>/s1/opcua_extraction.p4
 * — use that for any result. This copy may diverge and is not validated. */
#include <core.p4>
#include <v1model.p4>
