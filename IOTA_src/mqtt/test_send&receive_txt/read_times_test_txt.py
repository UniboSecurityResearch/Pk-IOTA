...
test_listen = open("test_txt_listener_USA.txt", "r") 
lines_listen = test_listen.readlines()
tot_times = 0
num = 0
test_sender = open("./sender/test_txt_sender_USA.txt", "r")
...
for line_l in lines_listen:
   ...
   for line_s in lines_sender:
      ...
      if line_s_splitted[0] == line_l_splitted[0]:
         ...
         print("Total time:" + str(arrivo-invio_iniziato) + "  Spread time:" + str(arrivo-invio_completo) + " " + str(num))
